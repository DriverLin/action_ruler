...
os.system("sudo mkdir /mnt/managaMountPoint")
os.system("nohup sudo -E rclone --config ./rclone.conf mount onedrive:Manga  /mnt/managaMountPoint --vfs-cache-mode full &")
sleep(5)
for (mid,mname) in watchList:
    copymanga_download(mid, mname, "/mnt/managaMountPoint")
