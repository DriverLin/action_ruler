    ...
    if os.path.exists(path):
        ...
        while True:
            try:
                ...
                print(">" * retry, "success : ", path)
                break
            except Exception as e:
                print(">" * retry, url, path, e)
                retry += 1
                sleep(1)
    ...
    if name in zfp.namelist():
        ...
        while True:
            try:
                ...
                write_lock.release()
                print(">" * retry, "success : ", name)
                break
            except Exception as e:
                print(">" * retry, "error! : ", name, "\t", e)
                retry += 1
                sleep(1)
    ...
    try:
        ...
        for i in range(int(total / 100)):
            ...
            for ch in tmp["results"]["list"]:
                chapters.append(ch)
        print(">" * retry, "get_chapters", comic_id)
        return chapters
    except Exception as e:
        print(">" * retry, e)
        sleep(1)
...
def get_pages(comic_id, chapter_uid, retry=0):
    ...
    try:
        ...
        print(">" * retry, "get_pages", comic_id, chapter_uid)
        return imgs
    except Exception as e:
        print(">" * retry, e)
        sleep(1)
...
if __name__ == "__main__":
    for mid, mname in [
        ...
        copymanga_download(mid, mname, "D:/")
